...
type MessageKey =
  ...
  | 'saveThisReference' | 'bookingReference' | 'confirmationIfEmailed' | 'noPaymentHold'
  | 'lookupCodeLabel' | 'lookupCodePlaceholder' | 'enterReference'
  | 'cancelVisit' | 'confirmCancelVisit' | 'moveVisit' | 'saveNewTime'
  | 'visitCancelled' | 'visitMoved' | 'bookingErrorGeneric' | 'bookingErrorValidation'
  | 'bookingErrorUnavailable' | 'appointmentBook' | 'dayView' | 'weekView' | 'todaysBook'
  | 'noVisitsToday' | 'guest' | 'filterAll' | 'pageNotFound' | 'pageNotFoundIntro' | 'backToSalon'
  | 'skipToContent'
...
const messages: Record<Locale, Record<MessageKey, string>> = {
  en: {
    ...
    noPayment: 'No payment is taken online. Save your booking reference to view or change this visit.',
    confirmationInbox: 'Your booking is saved for', inTheBooks: 'It is in the books',
    seeYouSoon: 'See you soon.', confirmationSent: 'We have kept a chair for you.',
    saveThisReference: 'Save this reference. You will need it, with your email, to view, move, or cancel.',
    bookingReference: 'Booking reference',
    confirmationIfEmailed: 'A copy has also been sent to',
    noPaymentHold: 'No payment is taken online. Bring this reference if you need to change the visit.',
    lookupCodeLabel: 'Booking reference',
    lookupCodePlaceholder: 'ABC123',
    enterReference: 'Enter the six-character reference from your confirmation.',
    cancelVisit: 'Cancel visit',
    confirmCancelVisit: 'Cancel this visit and free the chair?',
    moveVisit: 'Move visit',
    saveNewTime: 'Save new time',
    visitCancelled: 'This visit is cancelled.',
    visitMoved: 'This visit has been moved.',
    bookingErrorGeneric: 'We could not complete that booking. Check the details and try again.',
    bookingErrorValidation: 'Check your name, email, and phone, then try again.',
    bookingErrorUnavailable: 'That employee is not free at the selected time.',
    appointmentBook: 'Appointment book',
    dayView: 'Day',
    weekView: 'Week',
    todaysBook: 'Who is in today.',
    noVisitsToday: 'No visits on this date.',
    guest: 'Guest',
    filterAll: 'All chairs',
    pageNotFound: 'This page is not on the map.',
    pageNotFoundIntro: 'The link may be out of date. Come back to the salon or reserve a chair.',
  ...
  ar: {
    ...
    noPayment: 'لا يُطلب دفع عبر الموقع. احتفظ برقم المرجع لعرض الزيارة أو تعديلها.',
    confirmationInbox: 'تم حفظ حجزك لـ', inTheBooks: 'تم تسجيل الموعد',
    seeYouSoon: 'نراك قريباً.', confirmationSent: 'احتفظنا بمقعد لك.',
    saveThisReference: 'احتفظ بهذا المرجع. ستحتاجه مع بريدك لعرض الزيارة أو نقلها أو إلغائها.',
    bookingReference: 'مرجع الحجز',
    confirmationIfEmailed: 'أرسلنا نسخة أيضاً إلى',
    noPaymentHold: 'لا يُطلب دفع عبر الموقع. أحضر هذا المرجع إذا احتجت إلى تغيير الزيارة.',
    lookupCodeLabel: 'مرجع الحجز',
    lookupCodePlaceholder: 'ABC123',
    enterReference: 'أدخل المرجع المكوّن من ستة أحرف من رسالة التأكيد.',
    cancelVisit: 'إلغاء الزيارة',
    confirmCancelVisit: 'إلغاء هذه الزيارة وإفراغ المقعد؟',
    moveVisit: 'نقل الزيارة',
    saveNewTime: 'حفظ الوقت الجديد',
    visitCancelled: 'أُلغيت هذه الزيارة.',
    visitMoved: 'تم نقل هذه الزيارة.',
    bookingErrorGeneric: 'تعذر إتمام الحجز. تحقق من البيانات وحاول مرة أخرى.',
    bookingErrorValidation: 'تحقق من الاسم والبريد والهاتف ثم حاول مرة أخرى.',
    bookingErrorUnavailable: 'هذا الموظف غير متاح في الوقت المحدد.',
    appointmentBook: 'سجل المواعيد',
    dayView: 'يوم',
    weekView: 'أسبوع',
    todaysBook: 'من يأتي اليوم.',
    noVisitsToday: 'لا زيارات في هذا التاريخ.',
    guest: 'الضيف',
    filterAll: 'كل المقاعد',
    pageNotFound: 'هذه الصفحة ليست على الخريطة.',
    pageNotFoundIntro: 'قد يكون الرابط قديماً. عد إلى الصالون أو احجز مقعداً.',
