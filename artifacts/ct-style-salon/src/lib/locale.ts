...
const messages: Record<Locale, Record<MessageKey, string>> = {
  en: {
    ...
    employeeRemoved: 'has been removed from booking.', employeeRemoveError: 'We could not remove this employee. Please try again.',
     ...
     uploading: 'Uploading', photoUploadHint: 'PNG, JPEG, WebP, or GIF up to 5 MB.', photoUploadError: 'Choose a PNG, JPEG, WebP, or GIF image up to 5 MB and try again.',
  ...
  ar: {
    ...
    employeeRemoved: 'تمت إزالته من الحجوزات.', employeeRemoveError: 'تعذر إزالة الموظف. حاول مرة أخرى.',
     ...
     uploading: 'جارٍ الرفع', photoUploadHint: 'PNG أو JPEG أو WebP أو GIF حتى 5 ميغابايت.', photoUploadError: 'اختر صورة PNG أو JPEG أو WebP أو GIF بحجم لا يتجاوز 5 ميغابايت وحاول مرة أخرى.',
