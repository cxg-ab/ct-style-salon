...
type MessageKey =
  ...
  | 'language' | 'heroTitle' | 'locationLine' | 'featuredEmpty'
   ...
   | 'archive' | 'archivedAppointments' | 'exportCsv' | 'todaysWorkload' | 'totalAppointmentsToday' | 'confirmedToday' | 'needsConfirmation' | 'nextVisit'
  ...
  en: {
    ...
    nameSaved: 'name is saved.', nameRequired: 'Enter an employee name.',
     ...
     archive: 'Archive', archivedAppointments: 'Archived appointments', exportCsv: 'Export CSV',
       todaysWorkload: 'Today’s workload', totalAppointmentsToday: 'Total appointments today', confirmedToday: 'confirmed', needsConfirmation: 'Needs confirmation', nextVisit: 'Next visit',
    ...
    nameSaved: 'تم حفظ الاسم.', nameRequired: 'أدخل اسم الموظف.',
     ...
     confirmDelete: 'تأكيد الحذف', serviceDeleted: 'تمت إزالتها من القائمة.',
      ...
      archive: 'الأرشيف', archivedAppointments: 'المواعيد المؤرشفة', exportCsv: 'تصدير CSV',
       todaysWorkload: 'مهام اليوم', totalAppointmentsToday: 'إجمالي مواعيد اليوم', confirmedToday: 'مؤكد', needsConfirmation: 'بحاجة لتأكيد', nextVisit: 'الزيارة التالية',
