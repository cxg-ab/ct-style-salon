...
function ManagerOverview({ onOpenTeam }: { onOpenTeam?: () => void }) {
  ...
  const todaysWorkload = todayAppointments.filter((appointment) => appointment.status === 'confirmed').length;
